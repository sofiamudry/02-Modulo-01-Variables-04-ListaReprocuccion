...
alert('Hola, Bienvenide, cree su lista que reproduccion aqui');

const nombre = prompt('Ingrese el nombre de su lista');
const cancion01 = prompt('Ingrese el nombre de la cancion');
